...
const validarEvento = (parametros) => {
   ...
   let validateUbicacion = !validator.isEmpty(parametros.lugar) && 
      ...
      // }
   let validateAnfitrion = !validator.isEmpty(parametros.anfitrion) && 
      validator.isLength(parametros.anfitrion, { min: 5, max: undefined });
      // if (!anfitrion) {
      //    console.log("Ubicacion no válida");
      // }
   ...
   // if (!validatePrecio){
   //    console.log("Precio no válida");
   // }

   if (!validateNombre || !validateDescripcion || !validateUbicacion || !validatePrecio || !validateAnfitrion) {
